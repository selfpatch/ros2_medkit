...
// =============================================================================
// XMedkitOperationItem - x-medkit vendor extension on OperationExecution
// responses (handle_get_execution / handle_create_execution).
//
...
inline constexpr auto dto_fields<XMedkitOperationItem> =
    std::make_tuple(field("goal_id", &XMedkitOperationItem::goal_id),
                    field("ros2_status", &XMedkitOperationItem::ros2_status),
                    field("ros2", &XMedkitOperationItem::ros2));
...
//   x-medkit               - free-form JSON; built by XMedkit() fluent builder
//                            containing ros2.{service|action,type,kind},
//                            entity_id, source, and optional type_info.
//                            Kept as nlohmann::json because type_info carries
//                            dynamic ROS IDL schemas.
// =============================================================================
